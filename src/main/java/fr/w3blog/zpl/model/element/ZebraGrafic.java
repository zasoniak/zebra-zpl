...
public class ZebraGrafic extends ZebraElement {
	...
	public ZebraGrafic(int positionX, int positionY, Double widthRatio, Double heightRatio, String lineColor, String hexValue, int totalBytesNumber, int bytesPerRow) {
